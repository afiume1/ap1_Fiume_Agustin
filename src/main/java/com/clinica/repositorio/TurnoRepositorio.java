 ...
 * Contiene todos los métodos de acceso a la tabla Turno en la base de datos.
 *
...
public class TurnoRepositorio {
    ...
    /**
     * Cancela un turno registrando la fecha de cancelación.
     *
     ...
     * Esto evita la duplicación de turnos.
     *
    ...
    /**
     * Devuelve todos los turnos activos de un profesional para una fecha dada.
     *
     * @param idProfesional el ID del profesional
     ...
     * @throws SQLException si ocurre un error en la base de datos
     */
    public List<Turno> listarPorProfesionalYFecha(int idProfesional, LocalDate fecha) throws SQLException {
        String sql = "SELECT t.*, " +
    ...
    /**
     * Devuelve todos los turnos de un paciente (historial completo).
     *
     * @param idPaciente el ID del paciente
     * @return lista de turnos del paciente ordenados por fecha descendente
     * @throws SQLException si ocurre un error en la base de datos
     */
